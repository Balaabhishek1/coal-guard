...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded bg-surface-container border border-outline-variant/40 text-on-surface shadow-md",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col space-y-1.5 p-space-lg pb-space-sm", className)}
    {...props}
  />
));
